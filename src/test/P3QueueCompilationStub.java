...
public class P3QueueCompilationStub {
	...
	public static void main(String[] args) {
		ULQueue<Integer> q = new ULQueue<>();
		q = new ULQueue<>(10);
		int capacity = q.capacity();
		q.clear();
		ULQueue<Integer> clone = q.clone();
		boolean empty = q.empty();
		Integer i = Integer.valueOf(7);
		q.push(i);
		Integer i2 = q.front();
		i2 = q.pop();
		int size = q.size();
		RuntimeException e1 = new ULEmptyQueueException();
		RuntimeException e2 = new ULEmptyQueueException("hello");
	}
